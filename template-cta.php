 ...
 * 
 * This template part displays the call-to-action section with contact options
 * including Call, Chat, Email Sales, and Email Support.
 * 
 * @package blankslate-dataon
 */

// Allow customization of the heading text via filter
$cta_heading = apply_filters( 'dataon_cta_heading', 'No one knows Microsoft hybrid cloud like DataON' );
?>
